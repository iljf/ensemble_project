...
parser.add_argument('--multi-step', type=int, default=10000, metavar='n', help='Number of steps for multi-step return')
...
parser.add_argument('--learn-start', type=int, default=int(1500), metavar='STEPS', help='Number of steps before starting training')
