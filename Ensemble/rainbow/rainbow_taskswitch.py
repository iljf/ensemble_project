...
from test import test, ensemble_test, test_taskswitch
...
if __name__ == '__main__':
    ...
    if args.id == 'Diverse_rainbow':
        ...
        wandb.init(project="taskswitch",
                   name="taskswitch_RAINBOW_" + args.game + " " + "_r_ " + args.game + "_Seed" + str(args.seed) + "_iteration_" + str(args.iteration),
                   config=args.__dict__
                   )
    ...
    # exp name
    exp_name = "taskswitch_" + args.id + '/' + args.game + '/' + args.model_name
    ...
    if args.evaluate:
        ...
        while T < args.learn_start:
            ...
            if T % args.replay_frequency == 0 and args.model_name in ('NoisyDQN', 'Rainbow'):
                dqn.reset_noise()  # Draw a new set of noisy weights
            if args.model_name in ('NoisyDQN', 'Rainbow'):
        ...
        for T in trange(1, args.T_max + 1):
            ...
            if game_bf != game_af:
                ...
                env = Action_random(env, eps=0.1)
                env.train()
                dqn.action_space = env.action_space()
            ...
            if T % args.replay_frequency == 0:
                if args.model_name == 'Rainbow':
                    batch_loss, CE_loss = dqn.learn(mem, args.model_name)
                else:
                    batch_loss, CE_loss = dqn.learn_by_name(mem, args.model_name)
            ...
            if T % args.evaluation_interval == 0:
                ...
                avg_reward, avg_Q = test_taskswitch(args, T, dqn, val_mem, metrics, results_dir, scheduler=scheduler, action_p=action_p)  # Test
